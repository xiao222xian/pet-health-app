...
class _AuthScreenState extends State<AuthScreen> with TickerProviderStateMixin {
  ...
  String _phoneToEmail(String phone) =>
      '${phone.replaceAll(RegExp(r'\s+'), '')}@phone.pet';
  ...
  String _friendlyError(String raw) {
    ...
    if (lower.contains('invalid login')) return '账号或密码错误，请重试';
    if (lower.contains('user_exists') ||
    ...
    if (lower.contains('rate limit')) return '注册请求过于频繁，请稍后再试';
    if (lower.contains('email not confirmed')) return '邮箱还未验证，请先查看邮件完成验证';
    if (lower.contains('signup') && lower.contains('disabled')) {
      return '当前暂未开放注册';
    }
    if (lower.contains('password')) return '密码至少需要6位';
                  ...
                  children: [
                      ...
                      builder: (_, __) {
                        ...
                        return Transform.translate(
                          ...
                          child: Column(children: [
                            ...
                            Text(_isSignUp ? '开始让你的毛孩子少生病' : '欢迎回来，铲屎官 👋',
                                style: TextStyle(
                                    fontSize: 14,
                    ...
                    AnimatedBuilder(
                      ...
                      builder: (_, child) => Transform.translate(
                          ...
                          child:
                              Opacity(opacity: _slideAnim.value, child: child)),
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: _loading
                  ...
                  : [
                      BoxShadow(
                          color: const Color(0xFF6B5ECD).withValues(alpha: 0.5),
                          blurRadius: 20,
