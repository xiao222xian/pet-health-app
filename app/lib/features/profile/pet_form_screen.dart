...
class _PetFormScreenState extends State<PetFormScreen> {
  ...
  Future<void> _save() async {
    ...
    final effectiveBreed = _isCustomBreed
        ? (_customBreedController.text.trim().isNotEmpty
    ...
    if (_imageFile != null) {
      try {
        ...
        payload['avatar_url'] = _toDataUrl(bytes);
      } catch (e) {
        if (mounted) _showError('头像保存失败，请重新选择一张照片试试');
            ...
            children: [
                      ...
                      itemBuilder: (_, i) {
                        ...
                        return GestureDetector(
                          onTap: () => setState(() {
                            _avatar = em;
                            _imageFile =
                                null; // clear custom image when emoji picked
                          }),
              ...
              _sectionCard(children: [
                ...
                CupertinoTextField(
                  ...
                  placeholderStyle:
                      const TextStyle(fontSize: 15, color: AppTheme.textHint),
                  decoration: BoxDecoration(
              ...
              _sectionCard(children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(children: [
                      Text(
                        _isCustomBreed ? '其他（自定义）' : (_breed ?? '点击选择品种'),
                        style: TextStyle(
                          fontSize: 15,
                          color: _breed != null
                              ? AppTheme.deepBlue
  ...
  Widget _buildAvatarPreview() {
    ...
    if (_avatar.startsWith('data:image/')) {
      final bytes = _decodeDataUrl(_avatar);
      if (bytes != null) {
